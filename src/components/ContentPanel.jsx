...
export default function TwoColumnPanel({ heading, color, children }) {
    ...
    return (
        <section class={`${color} py-16 tablet:py-16 h-screen max-h-[1000px] min-w-[400px] min-h-[800px] laptop:min-w-[800px] laptop:min-h-[1080px] mb-32 tablet:my-16 laptop:my-8`}>
            ...
            <div class="container px-8 laptop:px-0 h-full mx-auto mb-32 desktop:mb-16">
                {children}
            </div>
        </section>
    )
