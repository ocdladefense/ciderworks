...
export default function OrderProgress() {
    return (
        <>
            ...
            <section class="font-default-heading container-none laptop:container h-full mx-auto flex justify-between gap-8 mb-32 laptop:mb-16 grid grid-cols-1 tablet:grid-cols-3 tablet:grid-flow-row my-8 bg-wb-gray rounded-lg p-8">
